...
# Viasoft Front [![version][version-badge]][CHANGELOG] [![license][license-badge]][LICENSE]

Este proyecto se generó a partir de la plantilla  [Now UI Dashboard Angular](https://creativetimofficial.github.io/now-ui-dashboard-angular), del cual se deja la documentación al final
...
- esta plantilla se encontraba en la version V 11 de Angular, la cual se llevo a la V 13.0.1 y se actualizaron las dependencias.
- se agrega primeng para la utlizacion de los componentes de primefaces para angular
